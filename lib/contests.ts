...
export const CONTESTS: Contest[] = [
  ...
  },
  {
    ...
    short: "EUHF",
    cq: "CQ EUHF",
    aliases: ["EUHF", "EU HF", "EUHFC", "EUROPEAN HF", "EUROPEAN HF CHAMPIONSHIP"],
    bands: ["160", "80", "40", "20", "15", "10"],
    exchange: {
      youSend: "{rst} YY",
      note: "Send RST + 2-digit year you were first licensed (e.g. 09 if licensed in 2009). Europe only.",
      rst: true,
    },
    logs: { url: "https://log.s5cc.eu/", deadline: "within 2 days" },
    rules: "https://euhf.s5cc.eu/euhfc_rules/",
    tip: "First Saturday of August, 1200–2359Z. Short but loud — year-licensed mults matter.",
    tier: "major",
    recurrence: {
      kind: "annual",
      month: 7,
      rule: "saturday",
      n: 1,
      sessions: [{ startH: 12, durationH: 12 }],
    },
  },
  {
    id: "waecw",
  ...
  },
  {
    ...
    short: "TTC",
    cq: "TEST TTC",
    aliases: ["TTC", "TTC-SPCWC", "Tuesday", "Telegraphy", "TEST TTC"],
    bands: ["80", "40"],
    exchange: {
      youSend: "{rst} {serial}",
      note: "Send RST + serial. Same station may be worked again each 15-minute period (4 periods per hour).",
      rst: true,
    },
    logs: { url: "https://spcwc.pl/upload", deadline: "within 24 hours" },
    rules: "https://spcwc.pl/ttc/rules/en",
    tip: "Every Tuesday 1930–2030Z on 80/40. Call TEST TTC. Organized by SPCWC.",
    tier: "sprint",
    recurrence: {
      kind: "weekly",
      sessions: [{ days: [2], start: "1930", end: "2030" }],
    },
  },
  {
    id: "awt",
    ...
    short: "AWT",
    cq: "CQ AWT",
    aliases: ["AWT", "A1Club", "A1 CLUB", "CQ AWT"],
    bands: ["160", "80", "40", "20", "15", "10"],
    exchange: {
      youSend: "{rst} {name}",
      note: "Send RST + your CW name (handle). First 15 minutes are QRS (≤15 wpm).",
      rst: true,
    },
    logs: { url: "https://www.3830scores.com/" },
    rules: "https://a1club.org/contest/awt/",
    tip: "Every Wednesday 1145–1300Z. Friendly JA-sponsored weekly test open to everyone.",
    tier: "sprint",
    recurrence: {
      kind: "weekly",
      sessions: [{ days: [3], start: "1145", end: "1300" }],
    },
  },
  {
    id: "mt40",
    ...
    short: "MT40",
    cq: "CQ MT",
    aliases: ["MT40", "Mini-Test 40", "Mini Test 40", "MINITEST40"],
    bands: ["40"],
    exchange: {
      youSend: "{rst} {serial}",
      note: "40m only. RST + serial. Same station once per 10-minute period.",
      rst: true,
    },
    logs: { url: "https://ua9qcq.com/hf-logs.php" },
    rules: "http://minitest.narod.ru/",
    tip: "Every Wednesday 1700–1759Z on 40m.",
    tier: "sprint",
    recurrence: {
      kind: "weekly",
      sessions: [{ days: [3], start: "1700", end: "1759", bands: ["40"] }],
    },
  },
  {
    id: "mt80",
    ...
    short: "MT80",
    cq: "CQ MT",
    aliases: ["MT80", "Mini-Test 80", "Mini Test 80", "MINITEST80"],
    bands: ["80"],
    exchange: {
      youSend: "{rst} {serial}",
      note: "80m only. RST + serial. Same station once per 10-minute period.",
      rst: true,
    },
    logs: { url: "https://ua9qcq.com/hf-logs.php" },
    rules: "http://minitest.narod.ru/",
    tip: "Every Wednesday 1800–1859Z on 80m — right after Mini-Test 40.",
    tier: "sprint",
    recurrence: {
      kind: "weekly",
      sessions: [{ days: [3], start: "1800", end: "1859", bands: ["80"] }],
    },
  },
  {
    id: "nccc",
    ...
    short: "NS",
    cq: "CQ NS",
    aliases: ["NS", "NCCC", "NCCC Sprint", "CQ NS"],
    bands: ["160", "80", "40", "20", "15", "10"],
    exchange: {
      youSend: "{serial} {name} {spc}",
      note: "Send serial + name + QTH (state/province/country). Very short 30-minute sprint.",
      rst: false,
    },
    logs: { url: "https://www.3830scores.com/" },
    rules: "https://ncccsprint.com/",
    tip: "Typically Friday 0230–0300Z (Thursday evening NA). Fast and brief.",
    tier: "sprint",
    recurrence: {
      kind: "weekly",
      sessions: [{ days: [5], start: "0230", end: "0300" }],
    },
  },
  {
    id: "arrl160",
